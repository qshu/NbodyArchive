...
***** Note:------------------------------------------------------------**
c$$$      if(time.ge.1.40380859375000000E-002.and.name(i1).eq.5621) then
c$$$         if(j.ge.ifirst) then
c$$$         write(120+rank,*) j,name(j),(x0(k,j),k=1,3),(x0dot(k,j),k=1,3)
c$$$     &     ,(f(k,j),k=1,3),(fdot(k,j),k=1,3),time
c$$$         else
c$$$         write(120+rank,*) j,name(j),(x(k,j),k=1,3),(xdot(k,j),k=1,3)
c$$$     &     ,(f(k,j),k=1,3),(fdot(k,j),k=1,3),time
c$$$         end if
c$$$      end if
