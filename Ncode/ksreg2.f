...
*       Copy neighbour list of #ICOMP without JCOMP.
    ...
    1 CONTINUE
      ILIST(1) = NNB1 - 1
*
      IF (IQ.GT.0) WRITE (6,9)  (ILIST(K),K=2,NNB1)
    9 FORMAT (' ILIST:   ',10I6,12(/,5X,12I6))
      CALL FLUSH(6)
...
*       Update all relevant COMMON list arrays.
      CALL RENAME
*
      IF (IQ.GT.0) WRITE (6,39)  (LIST(K,I),K=2,NNB1)
   39 FORMAT (' RENAME:   ',10I6,12(/,5X,12I6))
      CALL FLUSH(6)
