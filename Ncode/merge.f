...
*       Initialize unperturbed ghost binary of outer component.
      ...
      LIST(1,2*JPAIR-1) = 0
*
*       Apply tidal correction for outer binary perturbers & inner c.m.
      JLIST(1) = 2*JPAIR - 1
      JLIST(2) = 2*JPAIR
*       Include inner c.m. in neighbour list (small bug fix 9/99).
      NNB1 = NNB + 1
      JPERT(NNB1) = ICOMP
      CALL NBPOT(2,NNB1,POT3)
      JLIST(1) = JCOMP1
      CALL NBPOT(1,NNB1,POT4)
*
