...
*       Replace final velocity by relative velocity for binary kick.
   ...
   15     CONTINUE
      ...
      END IF
*
*       Provide partial output, including late collision products.
      IF (NKICK.LT.50.OR.NAME(I).LE.2*NBIN0.OR.TTOT*TSTAR.GT.100.) THEN
          ZM = BODY(I)*ZMBAR
   ...
   20     FORMAT (' VELOCITY KICK:    I NAM K* KC* M0 M VI VK VF ',
     &                                2I6,2I4,2F7.2,3F7.1)
      ...
      END IF
*
*       Highlight velocities below 4 times initial rms velocity.
