...
*       Check for planetary systems - defined as HeWDs - and low-mass WDs!
      ...
      ENDIF
*
*       Collect additional diagnostics on unit 91 for planets. 
*     IF(K1.EQ.10.AND.M1.LT.0.002D0)THEN
*        CALL SOLAR(I2,I1)
*     ELSEIF(K2.EQ.10.AND.M2.LT.0.002D0)THEN
*        CALL SOLAR(I1,I2)
*     ENDIF
*
...
*       unless the less evolved star is a WD, NS or BH.
         IF(K2.LT.10)THEN
            ...
            DM = M2
            NTZ = NTZ + 1
            WRITE (6,2)  NAME(I1), NAME(I2)
    2       FORMAT (' NEW TZ    NM ',2I6)
...
*       Accumulate collision diagnostics on unit #13.
     ...
     &                   DM*ZMBAR, RS1, RS2, RI, RIJ*SU, TK
   35     FORMAT (1X,F6.1,2I6,3I4,4F5.1,2F7.2,F6.2,F7.2,1P,E9.1)
          CALL FLUSH(13)
      END IF
*
