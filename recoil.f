...
*       Include output of strong interaction from chaos case.
      IF (IEND.EQ.2.AND.PMIN.LT.3.0*SEMI.AND.ECC1.GT.1.0) THEN
          ...
          WRITE (6,25)  ECC, ECC1, PMIN/SEMI, RCDOT/RCP, SEMI, A1, RCP,
     &                  GB, ALPHA
   25     FORMAT (' RECOIL:    E E1 PM/A RD A A1 RP GB IN ',
     &                         F8.4,F6.2,F5.1,F6.1,1P,4E10.2,0P,F7.1)
      END IF
*
