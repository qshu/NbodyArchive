...
*
*       Quit in case of tidal dissipation (TMDIS controlled by IMPACT).
      IF (KSTARM(IM).EQ.-2) THEN
          GO TO 50
      END IF
*
...
*       Obtain growth time and modify KS elements from de/dt & dh/dt.
      I1 = 2*IPAIR - 1
*     IF(IM.EQ.3.AND.TMDIS(IM).LT.863.14)THEN
*        TMDIS(IM) = TMDIS(IM) + 1.0
*        GOTO 50
*     ENDIF
