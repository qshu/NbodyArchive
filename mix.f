...
*
      ...
      REAL*8 MCH,MXNS
      PARAMETER(MCH=1.44D0,MXNS = 1.8d0)
      LOGICAL  FIRST
      SAVE  FIRST
      DATA  FIRST /.TRUE./
*
...
*       Print cluster scaling parameters at start of the run.
          IF(NCOLL.EQ.0)THEN
              WRITE (15,20)  RBAR, BODYM*ZMBAR, BODY1*ZMBAR, TSCALE,
     &                       NBIN0, NZERO
...
*
*       Accumulate collision diagnostics on unit #15.
      WRITE (15,35)  TTOT, (ITYPE(JC,K),K=1,5), M1, M2, M3, DM*ZMBAR,
