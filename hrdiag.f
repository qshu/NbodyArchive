...
*
      ...
      real*8 mch,mxns,mlp,tiny
      parameter(mch=1.44d0,mxns=1.8d0,mlp=12.d0,tiny=1.0d-14)
      real*8 mtc
* 
      ...
      parameter(lum0=7.0d+04,kap=-0.5d0,ahe=6.964d0,aco=48.503d0)
*
      real*8 thookf,tblf
...
*
            ...
            lum = 635.d0*mt*xx/(aj+0.1d0)**1.4d0
