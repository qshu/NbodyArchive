...
*       Estimate perturbed distance from tidal limit approximation.
   ...
   10 CONTINUE
*
*       Save perturber membership (copy first neighbour if none).
      IF (NNB1.EQ.1) THEN
          LISTC(2) = LISTCM(2)
          LISTC(1) = 1
      ELSE
...
*       Ensure consistent perturbation indicator.
      ...
      END IF
*
*     WRITE (6,20)  ICH, LISTC(1), RSUM, RPERT, GPERT
*  20 FORMAT (' CHLIST:   ICH NP RSUM RPERT GPERT ',2I4,1P,3E9.1)
*
      RETURN
*
      END
