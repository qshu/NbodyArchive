...
*
*
*       Perturber list for chain reqularization.
*       -----------------------------------------
*
      INCLUDE 'common6.h'
...
*
*
*       Prepare perturber selection using maximum of 0.5*RSUM & RGRAV.
      RPERT = MAX(0.5*RSUM,RGRAV)
...
*       Form current perturbation from nearest body (effective value RPERT).
      ...
      NPERT = LISTC(1,1)
*     WRITE (6,20)  ICH, LISTC(1,1), RSUM, RPERT, GPERT, PMAX
*  20 FORMAT (' CHLIST:   ICH NP RSUM RPERT GPERT PMX ',2I4,1P,4E9.1)
