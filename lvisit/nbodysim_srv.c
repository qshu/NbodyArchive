...
int main(int argc,char **argv) {
 ...
 LOOP:
  ...
  if( (vscd = visit_srv_init_socket("demo", "nbody", "*", 0,
  ...
  lvisit_timing_init(visit_srv_basetime(vscd),"VIS");
 ...
 VERROR:
  ...
  printf("----- ending  nbodysim_srv, return code rc=0\n");
