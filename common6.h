...
*    
      COMMON/DRAGDAT/Q_DRAG,HZ,SMBH,D_SCALE,D_MASS,ALPHAR,D_DELTA,Q_REAL,
     &               D_MU  
*
      COMMON/DRAG1/ EDISS1_LOC,EDISS1,EDISS_SAVE,EBLCKHL,D_SIGM,
     &              EDISS1_LOC1,EDISS11,EDISS_SAVE1,ND_1
      COMMON/ORBITS/ P_1(ID,NMAX),P_1DOT(ID,NMAX),P_2(ID,NMAX),
     &               P_3(ID,NMAX),
     &               P_2DOT(ID,NMAX),P_3DOT(ID,NMAX),ITHIRD_POINT(NMAX)
*
