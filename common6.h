...
*
     ...
     &               NNTB,GAMREL(KMAX),ENEWT(KMAX),RELENERGY(KMAX),
     &		     ENEWT0(KMAX),RELENERGY0(KMAX),ILL(KMAX),
     &               ESCRELCOR(KMAX),RELENERGY2_5(KMAX),
     &               PREVRELENERGY,COLLISION,RELTSTEP(KMAX),ETOT1,
     &               EBIN1,EMERGE1,ECOLL0,SRELENERGY1,PREVRELENERGY1,
     &               RELENERGYDE,RELENERGY02_5(KMAX)		
*
...
*
     ...
     &               TDUMP,SCOEFF(12),TOFF,TTOT,CLIGHT
*
