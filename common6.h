...
*
     ...
     &               NRUN,MODEL,NC,NZERO,NBIN0,IDUM1,NAME0,NHI0,KZ(50),
...
*
     ...
     &               DUMMY1,XHYD,YHEL,ZMET,ZPARS(20),
...
*
     ...
     *  isernb,iserreg
*
      COMMON/REL/    RELENERGY1(KMAX),RELENERGY2(KMAX),
     &               RELENERGY2_5(KMAX),RELENERGY0(KMAX),ILL(KMAX),
     &               ESCRELCOR(KMAX),RELTSTEP(KMAX),
     &               PREVRELENERGY,PREVRELENERGY1,SRELENERGY,
     &               SRELENERGY1,BETAREL,DTUPN,VOVERC,RFLAG(KMAX),
     &               NXDUM,CLIGHTIN,CLIGHT,KSTHEFIRST,
     &               KSPERTHEADER,FIRSTREL,GAMMAREL1(KMAX),
     &               GAMMAREL2(KMAX),GAMMAREL2_5(KMAX),EBIN1,ESUB1,
     &               EMERGE1,ECOLL0,EMDOT1,ECDOT1
