...
*       Ensure that all neighbours are considered.
          IF (RIJ2.GT.(rs2fac*RCRIT2).AND.J.NE.NAMEJ) GO TO 60
...
*    *  ' items from ',irecv
*
      CALL MPI_SENDRECV(D2(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D2(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(D2R(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D2R(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(D3(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D3(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(D3R(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D3R(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
