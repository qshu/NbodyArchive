...
*IB       criteria for FIRR -- begin

          IF (RIJ2 .LE. RCRIT2) THEN

            LIRR1 = (RIJ2.LE.RS2)
            LIRR2 = (RIJ2.GT.RS2 .AND. STEP(J).LE.10.0*SMIN)
            LIRR3 = (RIJ2.GT.RS2 .AND. STEP(J).GT.10.0*SMIN .AND.
     &               DRDV.LE.VRFAC)

            IF (LIRR1 .OR. LIRR2 .OR. LIRR3)  THEN
...
*       Obtain potential.
              ...
              IF (LIRR2.OR.LIRR3) THEN

*       Correct the regular force.
...
*       Obtain potential and derivative.
              ...
              END IF     ! IF (LIRR2.OR.LIRR3)

            END IF      ! IF (LIRR1 .OR. LIRR2 .OR. LIRR3)

          END IF     ! IF (RIJ2 .LE. RCRIT2)

          END IF     ! IF J.NE.I

*IB       criteria for FIRR -- end

      END DO      ! DO J = IFIRST,N
