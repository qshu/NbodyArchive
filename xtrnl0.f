...
*       Define the angular velocity (z-component) and mass in N-body units.
          ...
          TIDAL(4) = 2.0*OMEGA
          GMG = GMG/ZMTOT
*       Adopt a large constant tidal radius for escaper removal at 2*RTIDE.
          RTIDE = 50.0
*
...
*       Define tidal radius in scaled units.
   70 IF (KZ(14).LE.2) THEN
          RTIDE = (ZMASS/TIDAL(1))**0.3333
          WRITE (6,55)  (TIDAL(K),K=1,4), TSCALE, RTIDE
   55     FORMAT (/,12X,'TIDAL PARAMETERS:  ',1P,4E10.2,
