...
*    *  ' items from ',irecv
*
      CALL MPI_SENDRECV(FI(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  FI(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(FR(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  FR(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(D1(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D1(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
      CALL MPI_SENDRECV(D1R(1,istart),3*icnt,MPI_REAL,isend,rank,
     *                  D1R(1,istrec),3*icnt2,MPI_REAL,irecv,irecv,
     *                  MPI_COMM_WORLD,status,ierr)
*
      call mpi_barrier(MPI_COMM_WORLD,ierr)
 1001 continue
