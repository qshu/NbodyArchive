...
*
     ...
     &               SMIN,RMIN2,RMIN22,STEPJ,ALPHA,ZNBX,ZNBX2,EBH,
...
*
     ...
     *  xtsub1,xtsub2,isernb,iserreg
      COMMON/REL/    RELENERGY(KMAX),ILL(KMAX),GAMMAREL,
     &               ESCRELCOR(KMAX),RELTSTEP(KMAX),
     &               PREVRELENERGY,PREVRELENERGY1,SRELENERGY,
     &               SRELENERGY1,BETAREL,DTUPN,VOVERC,RFLAG(KMAX),
     &               NXDUM,CLIGHTIN,KSTHEFIRST,RELPOTENERGY(KMAX),
     &               KSPERTHEADER,FIRSTREL,GAMREL(8,KMAX),EBIN1,ESUB1,
     &               EMERGE1,ECOLL0,EMDOT1,ECDOT1, AFIN(3), SPN(3,NMAX),
     &               RELSUM, RELSUM2, DIFFS(10), DEBUGC2D,
     &               PREVRELPOTENERGY
