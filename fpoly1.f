...
*////////////////////////////////////////////////////////
*      DO I=I1,I2
*      CALL DRAGFORCE(I,FI(1,I),FR(1,I),D1R(1,I))
*      CALL DRAGBLCKHL(I,FI(1,I),D1(1,I))
*      END DO
*       
*      DO 80 I = J1,J2
*          DO 70 K = 1,3
...
*      OPEN(15,FILE='drag.dat',STATUS='OLD',ERR=100)
*      READ(15,*) Q_DRAG,C1,C2,C3,HZ
*      PRINT*,Q_DRAG,C1,C2,C3,HZ
*      GO TO 110
*  100 PRINT*,'ERROR NO DRAG.DAT FILE!'
*  110 CONTINUE       
*
*     Call Drag Force
*      DO 90 I=I1,I2
*      CALL DRAGFORCE(I,FI(1,I),FR(1,I),D1R(1,I))
*      PRINT*,'FRRRRRRRRRRRRRRRRRRRR=',FR(1,10)
*      CALL DRAGBLCKHL(I,FI(1,I),D1(1,I))
*   90 CONTINUE
*
      RETURN     
