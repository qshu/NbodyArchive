...
*       Check option for external force.
      ...
      END IF
*
*       Central Force + Drag Force Initialisation
      IF (KCASE.NE.1) CALL DRAGMCO_INIT(I1,I2,1)
...
*       Form total c.m. force & first derivative and also AC components.
     ...
     &                                                        BODY(NTOT)
   60     CONTINUE
*         CALL DRAGSTARPCM(NTOT,FI(1,NTOT),D1(1,NTOT))
          CALL DRAGMCO_INIT(I1,I2,1)
	  CALL DRAGMCO_INIT(NTOT,NTOT,1)
          J1 = NTOT
          J2 = NTOT
      ELSE
          J1 = I1
