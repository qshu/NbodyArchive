...
***** Note:------------------------------------------------------------**
c$$$      if(tprev.ge.3.24401855468750000E-002.and.name(i1).eq.1901) then
c$$$         print*,rank,'ksint',i1,list(1,i1),x(1,i1),xdot(1,i1),time,tprev
c$$$         call flush(6)
c$$$      end if
...
*     G0 = GAMMA(IPAIR)
      ...
      GAMMA(IPAIR) = GI
*
*     --09/25/13 14:57-lwang-debug--------------------------------------*
***** Note:------------------------------------------------------------**
c$$$      if(tprev.ge.6.52122497558593750E-002.and.name(i1).eq.499) then
c$$$         print*,rank,'kscorrb',i1,step(i1),fp,fd
c$$$         call flush(6)
c$$$      end if
*     --09/25/13 14:57-lwang-end----------------------------------------*
...
*         print*,rank,'kscorra',i1,step(i1),tdot6,dt12,tdot5,
*     *        z5,dtu,tdot4,tdot3(ipair),one6,td2
*         call flush(6)
*      end if
*     --09/25/13 14:57-lwang-end----------------------------------------*
*
...
c$$$         print*,rank,'step',i1,step(i1),t0(i1),time,tdot6,dt12,tdot5,
c$$$     *        z5,dtu,tdot4,tdot3(ipair),one6,td2,ri
c$$$         call flush(6)
c$$$      end if
*      if(tprev.ge.6.52122497558593750E-002.and.name(i1).eq.499) then
