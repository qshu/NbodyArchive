...
*
* PN variables
      REAL*8 FRELP1(6),FRELP2(6),FRELP2_5(6)
      REAL*8 FRELD1(6),FRELD2(6),FRELD2_5(6)
      REAL*8 XI(6),VI(6),CMVI(3),VCM(6)
*
...
*
* ----------------------------------------------
* Determine and apply PN terms in KS polynomials
* ----------------------------------------------
*
* Determine if binary is relativistic.
...
*
     ...
     &           THEN
*
* Initialize PN correction parameters
            DO 112, II=1,3
               XI(II) = X(II,I1)
               XI(II+3) = X(II,I2)
               VI(II) = XDOT(II,I1)
...
* Calculate relativistic corrections
     ...
     &           FRELD2,FRELD2_5,VWHOLE)
      ...
      END IF
*
* Calculate a new DTU but save the old one for later PN purposes
