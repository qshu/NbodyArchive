...
*       Modify volume ratio by radial velocity factor outside the core.
      IF (RI2.GT.RC2.AND.KZ(39).EQ.0.AND.RI2.LT.100.0*RH2) THEN
...
*     IF (ABS(FIRR(1)-FI(1,I))/ABS(FIRR(1)).GT.1.0D-09) THEN
*     WRITE (6,740)  TIME, I, LIST(1,I),NNB, FIRR(1)-FI(1,I)
* 740 FORMAT (' CHECK!    T I NB0 NB DFI  ',F10.5,3I6,1P,2E12.4)
*     END IF
*     END IF
