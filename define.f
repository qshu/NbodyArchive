...
*                               =-1: input from dat.10, number is nbin0).
...
*      22  Initial m,r,v on #10 (=1: output; >=2: input; >=2 & < 6: Nbody-Unit).
*                           (=4&8: starlab, 3&7 tree, 2&6&9 nbody input format)
*                           (=9, ignore input mass, use IMF based on KZ(20))
