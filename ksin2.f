...
*       Copy KS pair index and set c.m. index.
      ...
      ICM = N + IPAIR
*
*       Distinguish first or second stage (termination: ICASE = 2 only).
...
*
      GO TO 100
*
*       Obtain force polynomial for c.m.
   50 CALL FPOLY1(ICM,ICM,0)
...
*
     ...
     &              (X(3,ICM) - RDENS(3))**2)
          WHICH1 = ' MERGE2 '
          IF (IPHASE.EQ.7) WHICH1 = ' RESET2 '
          WRITE (6,60)  WHICH1, TIME, NAME(ICOMP), NAME(JCOMP),
