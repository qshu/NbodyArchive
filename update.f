...
*       Replace c.m. by components and reduce subsequent members by one.
   60 DO 80 J = 1,NTOT
*     --10/29/13 13:38-lwang-bug-fix------------------------------------*
***** Note: another place to jump ghost particle as above--------------**
         IF (BODY(J).EQ.0.0D0) GO TO 80
*     --10/29/13 13:39-lwang-end----------------------------------------*
          NNB = LIST(1,J)
          L = NNB + 1
          MOVE = 0
