...
*
*
*       Set typical core mass of 0.3/0.5 sun for chain binary in next bin.
      IC = 1
...
*       Include safety check on mass ratio just in case.
    ...
    5     FORMAT (' WARNING!    GIANT    IC K* I M MC ',2I4,I6,2F7.2)
          SIG = 0.9
          CM(L,IC) = 0.9*M(I)
      END IF
*
...
*       FAC = (GM)^{1/2}*M_{env}^{1/3)/(R^{5/6}*L^{1/3}) = 8.48D+03 for S.U.
      QL = 8.48D+03*SQRT(ZM)*(ZME/ZL3)**0.33/RS**0.833
*
