...
*
      I2=I1+1
      CALL MASSCENTROBJECT(I1,XI(1),VI(1),FP(1),FD(1))
      CALL DRAGFORCE(I1,XI(1),VI(1),FP(1),FD(1),FREG,2)
      CALL MASSCENTROBJECT(I2,XI(4),VI(4),FP(4),FD(4))
      CALL DRAGFORCE(I2,XI(4),VI(4),FP(4),FD(4),FREG,2)
*
