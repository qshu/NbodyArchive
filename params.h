...
*       ------------------
*
      PARAMETER  (NMAX=300000,KMAX=50,LMAX=64,NNBMX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=50000,KMAX=50,LMAX=64,NNBMX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=32768,KMAX=50,LMAX=64,NNBMX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=16384,KMAX=50,LMAX=64,NNBMX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=10100,KMAX=3000,LMAX=256,NNBMX=LMAX-3,MMAX=60,
*     PARAMETER  (NMAX=5100,KMAX=2000,LMAX=256,NNBMX=LMAX-3,MMAX=60,
*     PARAMETER  (NMAX=1010,KMAX=50,LMAX=60,NNBMX=LMAX-3,MMAX=1,
