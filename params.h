...
*       ------------------
*
      PARAMETER  (NMAX=50000,KMAX=5000,LMAX=128,MMAX=100,
*     PARAMETER  (NMAX=25000,KMAX=5000,LMAX=128,MMAX=100,
*     PARAMETER  (NMAX=16384,KMAX=50,LMAX=64,MMAX=100,
*     PARAMETER  (NMAX=10100,KMAX=3000,LMAX=256,MMAX=100,
*     PARAMETER  (NMAX=5100,KMAX=2000,LMAX=256,MMAX=100,
*     PARAMETER  (NMAX=1010,KMAX=50,LMAX=60,MMAX=100,
