...
*       ------------------
*
*     PARAMETER  (NMAX=50000,KMAX=50,LMAX=64,NNBMAX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=32768,KMAX=50,LMAX=64,NNBMAX=LMAX-3,MMAX=10,
*     PARAMETER  (NMAX=16384,KMAX=50,LMAX=64,NNBMAX=LMAX-3,MMAX=10,
      PARAMETER  (NMAX=5100,KMAX=5000,LMAX=256,NNBMAX=LMAX-3,MMAX=60,
*     PARAMETER  (NMAX=1010,KMAX=50,LMAX=60,NNBMAX=LMAX-3,MMAX=1,
