...
*     Diagnostics
*        if(rank.eq.0) then
*           write(6,61) IPAIR, NAME(ICM), NAME(I1),NAME(I2),STEP(ICM),
*    &           STEP(I1),LIST(1,ICM),LIST(1,I1),GAMMA(IPAIR),IMOD
*61         format('KS PAIR: IPAIR',I10,' NAME(ICM,I1,I2)',3I10,
*    &           ' STEP(ICM,I1)',1P,2E17.5,0P,' NNB',I5,' NP',I5,
*    &           ' GAMMA',1P,E17.5,0P,'  IMOD',I3)
*        end if
