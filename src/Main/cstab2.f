...
*       Check hierarchical stability condition (SEMI1 > 0 => ECC1 < 1).
      ITERM = 0
      IF (PMIN.GT.PCRIT.AND.SEMI.GT.0.d0.AND.SEMI1.GT.0.d0) THEN
          ITERM = -1
          if(rank.eq.0)then
