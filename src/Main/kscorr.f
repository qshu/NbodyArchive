...
*     safe for parallel, no value change, used value: islow
      ...
      REAL*8  UI(4),UIDOT(4),XI(6),VI(6),FP(6),FD(6),FREG(4),FRD(4),
     &        A1(3,4),A(8),PR(4),PRD(4),U2(4),U3(4),U4(4),U5(4),FD1(3)
      PARAMETER  (ITLOW=2)
*
*
...
*       Improve the solution of U and UDOT.
     ...
     &               0.5d0*U2(K))*DTU + UDOT(K,IPAIR))*DTU + U0(K,IPAIR)
              UIDOT(K) = (((U5(K)*DTZ + U4(K)*Z3)*DT3 +
     &                     0.5d0*U3(K))*DTU + U2(K))*DTU + UDOT(K,IPAIR)
   25     CONTINUE
*
