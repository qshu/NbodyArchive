...
*
     ...
     &         5.172d-02*mass**3
            pre2 = -4.56878d0 - 4.05305d0*mass + 1.24575d0*mass**2 -
     &         0.10922d0*mass**3
            pre3 = 3.01153d0 + 1.85745d0*mass -0.64290d0*mass**2 +
     &         5.759d-02*mass**3
         endif
*
         rzams = rzamsf(mass)
...
*
                  ...
                  lum = 1.0d-10
                  r = 1.0d-10
       elseif((psflag.eq.1).and.(mcbagb.ge.45.d0)
     &         .and.(mcbagb.le.65.d0))then
...
* psflag=1 strong PPSN condition
                        ...
                        mt = 0.9d0*mt
                        mc = mt
       elseif((psflag.eq.2).and.(mcbagb.ge.40.d0)
     &   .and.(mcbagb.le.65.d0))then
* psflag=2 moderate PPSN condition (Leung et al. 2019)
     ...
     &                     mt = -14.3d0*mcbagb + 938.0d0
                        ...
                        mt = 0.9d0*mt
                        mc = mt
       elseif((psflag.ge.3).and.(mcbagb.ge.40.d0)
     &   .and.(mcbagb.le.65.d0))then
