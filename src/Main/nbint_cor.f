...
c$$$      end if
     ...
     &        LIST(1,I),LIST(2,I),NAME(LIST(2,I))
         call flush(6)
 81      format(I3,' Warning!: Irregular step jumping! I',I10,' N',I10,
     &        ' ratio',E10.3,' dt0',F20.17,' step',F20.17,
     &        ' stepr',F20.17,' FI',E13.5,
     &        ' FD',E13.5,' D2',E13.5,' D3',E13.5,' t',F21.17,
     &        ' t0',F20.17,' t0r',F20.17,
     &        ' NB',I4,' LIST1',I10,' N1',I10)
...
*       Select discrete value (increased by 2, decreased by 2 or unchanged).
      IF (TTMP.GT.2.0*STEP(I)) THEN
          IF (MOD(TIME,2.0*STEP(I))<1.D-14) THEN
