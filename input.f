...
*
      OPEN(75,FILE='drag.dat',STATUS='OLD',ERR=60)
      READ(75,*) Q_DRAG, CD3, HZ, CMBLHOLE, EPS1
      WRITE (6,31)
   31 FORMAT(//,10X,'Q_DRAG,CD3,HZ,CMBLHOLE,EPS1')
      WRITE (6,32) Q_DRAG,CD3,HZ,CMBLHOLE,EPS1
   32 FORMAT(/,1P,5E12.5)
*     PRINT*, Q_DRAG, CD3, HZ, CMBLHOLE, EPS1
      GO TO 70
