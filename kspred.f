...
*       Predict KS motion to full accuracy including Stumpff functions.
      DTU = DTAU(IPAIR)
!!!!!!!!!!!!!!!
!	IF(TIME.LT.0.0000000725.AND.TIME.GT.0.0) THEN
!	 DTU = 2.06912731E-06	
!        END IF
!!!!!!!!!!!!!!!
      DO 20 K = 1,4
...
*
!!!!!!!!!!!!!!!
!	WRITE(*,333)'KXPRED',TIME,SQRT(VI(1)**2.0+VI(2)**2.0+VI(3)**2.0)
!&,SQRT(VI(4)**2.0+VI(5)**2.0+VI(6)**2.0),(19.0*
!&(VI(1)**2.0+VI(2)**2.0+VI(3)**2.0)+
!&(VI(4)**2.0+VI(5)**2.0+VI(6)**2.0))/2.0
!  333  FORMAT(A6,4F45.25)
!!!!!!!!!!!!!!!
      RETURN
*
      END
