...
*
 ...
 3     CONTINUE
*
*     First correction of cluster mass and computation of tidal radius
          XMCL0 = XMCL
          CALL GCLMASS(RDENS)
*
*     Correction of regular force and derivative due to change of cluster mass.
*
...
*
         DO 8 K = 1,3
         DEDFF = DEDFF + 
     *      BODY(I)*XFUNC*ADF(K)*(XDOT(K,I) + VG(K))*DTDF
 8       CONTINUE
 200  CONTINUE
*
      TGCL = TIME
