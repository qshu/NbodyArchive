...
*
      ...
      END DO
*
      IF(V23(J).LT.0.0.AND.V2(J).GT.0.0.AND.TTOT.GT.15.0
     &.OR.V12(J).LT.0.0.AND.V1(J).GT.0.0.AND.TTOT.GT.15.0) THEN
*
...
*     
     ...
     &   XI(3)*XIDOT(3)
      ...
      END IF
*
      IF(ANGL_P2P3.GE.30.0D0.AND.P3_FIXED(J)) THEN
      ANGLE_P2P3=0.0
      P123(J)=.TRUE.
      END IF	
*
