...
***** Note:------------------------------------------------------------**
c$$$          if(rank.eq.0.and.time.ge.3.11303138732910156E-003) then
c$$$             print*,'TSTEP FDUM',FDUM,'D1',D1(1,I),'D2',D2(1,I),'D3',
c$$$     &            D3(1,I),'ETAI',ETAI,'FR',FR(1,I),'D1R',D1R(1,I),
c$$$     &            'D2R',D2R(1,i),'D3R',D3r(1,i),'ETAR',etar,'I',I,'N',N,
c$$$     &            'LIST',LIST(1,I)
c$$$             call flush(6)
c$$$c$$$             print*,FDUM(IDD)
c$$$          end if
