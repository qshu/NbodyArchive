...
cmbody.f cmcorr.f cmfirr.f cmfreg.f cmgrel.f core.f cputim.f data.f define.f \
...
kscorr.f ksin2.f ksinit.f ksint.f kslist.f ksmod.f ksrel.f ksperi.f kspert.f \
...
ycopy.f ysave.f zare.f rs2modf.f eccy.f eccydo.f cubecalc.f
