...
#----------------------------------------------------------------------------
mpich:
	$(MAKE) $(RESULT) "FC = pgf77" "FFLAGS = -tp p7 -pc 64 -fast -O2 -D PUREMPI -D PARALLEL" \
...
dragmbhinit.f dragforce.f dragforce1.f dragblckhl.f dragblckhl1.f \
orbitelements.f \
